                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Detalhes da <strong>Resolução 001/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-footer">
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <div class="position">
                                                <a href="<?= base_url() ?>index.php/resolucao" type="button" class="btn btn-secondary  text-right"><i data-feather='corner-down-left'></i> Voltar</a>
                                                <a href="<?=base_url()?>index.php/resolucao/edresolucao" type="button" class="btn btn-success"><i data-feather='edit'></i> Editar</a>
