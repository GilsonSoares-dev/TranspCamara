                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span>Detalhes da <strong>Ata de Registro de Preços 127/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Ata de Registro de Preço 127/2021</p>
                                </div>
                                <div>
                                    ...
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url() ?>index.php/contratos/editaAta" class="btn btn-success"><i data-feather='edit'></i> Editar</a>
