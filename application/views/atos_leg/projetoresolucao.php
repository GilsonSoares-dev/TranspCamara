                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Os projetos de resolução são destinados a regular as matérias da competência privativa da Câmara e as de caráter político, processual, legislativo ou administrativo.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Projetos de Resolução</h4><br><br>
                            <!--
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/atos_leg/nprojetoresolucao" class="btn btn-primary">
