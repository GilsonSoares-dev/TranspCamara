                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Adicionar Ata de Sessão</p>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label style="font-size: 13px;">Tipo de Sessão</label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <div style="float: right;" class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url() ?>index.php/atos_leg/atas">Voltar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
