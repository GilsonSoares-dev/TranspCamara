                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Parecer de Comissões</h4><br><br>
                            <!--
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/atos_leg/novoparecer" class="btn btn-primary">
                            ...
                            <section id="basic-examples">
                                ...
                                <div class="row" id="table-hover-row">
                                    ...
                                    <div style="margin-left: -33px" class="col-md-3 ">
                                        <div class="form-group">
                                            <select class="select2 form-control">
                                                <option value="Modalidade">Comissão</option>
                                                <option value="">Justiça e Redação</option>
                                                <option value="">Constituição, Justiça e Redação</option>                                                
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <table class="table table-hover table-striped custom_tabela">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 17%;">Data de Publicação</th>   
                                                            <th style="width: 23%;">Comissão</th>                                                                                                    
                                                            <th style="width: 50%;">Ementa</th>                                                            
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/atos_leg/novoparecer';">                                                          
                                                            <td>014</td> 
                                                            <td>06/06/2021</td>                                                          
                                                            <td>JUSTIÇA E REDAÇÃO</td>
                                                        ...
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/atos_leg/novoparecer';">                                                          
                                                            <td>015</td> 
                                                            <td>06/06/2021</td>                                                          
                                                            <td>CONSTITUIÇÃO, JUSTIÇA E REDAÇÃO</td>
