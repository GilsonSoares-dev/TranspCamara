                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Aprovado, o Projeto será submetido à Comissão de Redação, caso tenham sido acatadas as emendas apresentadas, e publicado um Autógrafo, que é um decreto da Assembleia Legislativa expressando a forma final da proposta aprovada pelos representantes dos cidadãos.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Autógrafos de Lei</h4><br><br>
                            <!--
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/atos_leg/nautografo" class="btn btn-primary">
                                                ...
                                                <table class="table table-hover table-striped custom_tabela">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 80%;">Ementa</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/autografolei/dtautografo';">
                                                            <td><span class="font-weight-bold">127/2021</span></td>
                                                            <td>26/03/2021</td>
