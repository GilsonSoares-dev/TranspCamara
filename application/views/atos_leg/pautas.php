                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Pautas de Sessão é o resumo do assunto que há de ser tratado na sessão.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Pautas de Sessão</h4><br><br>
                            <!--
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/atos_leg/novapauta" class="btn btn-primary">
                            ...
                            <section id="basic-examples">
                                ...
                                <div class="row" id="table-hover-row">
                                    ...
                                    <!-- Basic -->                                                          
                                    <div style="margin-left: -54px" class="col-md-2">
                                        <div class="card-body">
                                            <select class="select2 form-control">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped custom_tabela">
                                                    ...
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/atos_leg/novapauta';">                                                                                                                   
                                                            <td>06/06/2021</td>                                                          
