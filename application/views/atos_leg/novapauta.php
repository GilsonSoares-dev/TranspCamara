                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Adicionar Pauta de Sessão</p>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label style="font-size: 13px;" for="">Data da sessão</label>
                                                <div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a style="margin-left: 352px" href="<?= base_url() ?>index.php/atos_leg/pautasessao" type="button" class="btn btn-primary waves-effect waves-float waves-light"><i data-feather='arrow-left'></i> Voltar</a>
                                    <div style="float: right;" class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url() ?>index.php/atos_leg/pautasessao">Voltar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
