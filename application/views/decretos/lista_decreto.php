                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Decreto é um ato normativo de competência exclusiva do poder legislativo com eficácia análoga a de uma lei</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Decretos</h4><br><br>
                                ...
                                <a href="<?= base_url() ?>index.php/decretos/cadDecreto" class="btn btn-primary">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/decretos/detalheDecreto';">
