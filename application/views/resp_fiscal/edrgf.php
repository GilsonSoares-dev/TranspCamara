                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Editar <strong>RGF - 3º Quadrimestre</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">RGF - 3º Quadrimestre </p>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                                <label style="font-size: 13px;" for="">Período</label>
                                                <select class="select2 form-control">
                                                    <option value="">Selecione</option>
                                                    <option value="">1° Semestre</option>
                                                    <option value="">2° Semestre</option>
                                                    <option value="">1° Quadrimestre</option>
                                                    <option value="">2° Quadrimestre</option>
                                                    <option value="">3° Quadrimestre</option>
                                                </select>
                                            </div>
                                        </div>
