                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>A Renúncia Fiscal (REFIS) é uma isenção fiscal que ocorre quando o órgão abre mão da cobrança de um determinado imposto para um público específico.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Renúncia Fiscal</h4><br><br>
                                <!---
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/resp_fiscal/nrenuncia" class="btn btn-primary">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 20%;">Tributo</th>
                                                            <th style="width: 20%;">Modalidade</th>
                                                            <th style="width: 45%;">Programa</th>
                                                            <th style="width: 15%;">Lei Regulamentar</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/resp_fiscal/dtrenuncia';">
                                                            <td><span class="font-weight-bold">REFIS</span></td>
                                                            <td>RENÚNCIA DE RECEITA</td>
                                                            <td>PESSOAS FÍSICAS E JURÍDICAS QUE SE ENCONTREM NA DÍVIDA ATIVA.</td>
                                                            <td>Lei 2029/2021</td>
                                                    </tbody>
                                                </table>
                                            </div>
