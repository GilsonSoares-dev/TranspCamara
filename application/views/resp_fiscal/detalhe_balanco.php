                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a style="margin-left: 352px" href="<?= base_url() ?>index.php/resp_fiscal" type="button" class="btn btn-primary waves-effect waves-float waves-light"><i data-feather='arrow-left'></i> Voltar</a>
                                    <div style="float: right;" class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url() ?>index.php/resp_fiscal">Voltar</a>
                                        </div>
                                    </div>
                                </div>
