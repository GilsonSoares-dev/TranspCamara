                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Editar <strong>Parecer do Tribunal de Contas</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Editar Parecer do Tribunal de Contas</p>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-5 ">
                                            <div class="form-group">
                                                <label style="font-size: 13px;" for="">Tipo de Parecer</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label style="font-size: 13px;" for="">Referência do Documento</label>
                                                <select class="select2 form-control">
                                                    <option value="">Selecione</option>
