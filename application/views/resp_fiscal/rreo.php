                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>O Relatório Resumido da Execução Orçamentária (RREO) é um documento mensal disponibilizado pelo Órgão Governamental que permite o acompanhamento e análise do desempenho das ações governamentais estabelecidas na Lei de Diretrizes Orçamentárias (LDO) e na Lei Orçamentária Anual (LOA). </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Relatório Resumido da Execução Orçamentária (RREO)</h4><br><br>
                                <!---
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/resp_fiscal/cadrreo" class="btn btn-primary">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/resp_fiscal/dtrreo';">
