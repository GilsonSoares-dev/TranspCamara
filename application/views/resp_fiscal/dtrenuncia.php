                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span>Detalhe da Renúncia Fiscal: <strong>REFIS</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Renúncia Fiscal: <strong>REFIS</strong></p>
                                </div>
                                ...
                                <div class="card-footer">
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <div class="position">
                                            <a href="<?= base_url() ?>index.php/resp_fiscal/edrenuncia" type="button" class="btn btn-warning  text-right"><i data-feather='edit'></i> Editar</a>
