                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Detalhes e Download de <strong>Portaria 001/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Portaria 001/2021</p>
                                </div>
                                <div>
                                    ...
                                    <div class="col-12 text-right">
                                        <a href="<?=base_url()?>index.php/portarias/editaPortaria" type="button" class="btn btn-success"><i data-feather='edit'></i> Editar</a>
                                    </div><br>
                                </div>
                            </div>
                        </div>
