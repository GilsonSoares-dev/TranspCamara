                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>
                                        Portaria é um ato administrativo normativo que visa à correta aplicação da lei, expressando, em minúcia, o mandamento abstrato da lei, com a mesma normatividade da regra legislativa.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Portarias</h4><br><br>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/portarias/detalhePortaria';">
