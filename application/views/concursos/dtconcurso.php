                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Detalhes do <strong>Concurso Público 001/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Concurso Público 001/2021</p>
                                </div>
                                <div>
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <div class="position">
                                            <a href="<?= base_url() ?>index.php/concursos/edconcurso" type="button" class="btn btn-warning  text-right"><i data-feather='edit'></i> Editar</a>
