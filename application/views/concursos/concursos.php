                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span> Concurso Público é a investidura em cargo ou emprego público que depende de aprovação prévia em concurso público de provas ou de provas e títulos.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Concursos Públicos</h4><br><br>
                                <!---
                                <div class="col-md-2">
                                ...
                                --->
                                <a href="<?= base_url() ?>index.php/concursos/nconcurso" class="btn btn-primary">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/concursos/dtconcurso';">
                                                            <td><span class="font-weight-bold">001/2021</span></td>
