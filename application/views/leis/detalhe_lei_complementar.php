                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Detalhes e Download da <strong>Lei Complementar - 006/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Lei Complementar - 006/2021 </p>
                                </div>
                                <div>
                                    ...
                                    <div class="col-12 text-right">
                                        <a href="<?=base_url()?>index.php/LeiComplementar/editaLeiComp" type="button" class="btn btn-success"><i data-feather='edit'></i> Editar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
