                        ...
                        <div><br>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    ...
                                    <span> Detalhes e Download de <strong>Emenda de Lei 145/2021</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Emenda 145/2021</p>
                                </div>
                                <div>
                                    ...
                                    <div class="col-12 text-right">
                                        <button type="button" class="btn btn-success"><i data-feather='edit'></i> Editar</button>
