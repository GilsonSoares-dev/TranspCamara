                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Solicitar ou Acompanhar pedido de informação</p>
                                </div>
                                <div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p align="justify">
                                                    A Lei Federal nº 12.527/2011 garante ao cidadão o direito
                                                    ...
                                                    e apresentar reclamações sem burocracia.
                                                </p><br>
                                            </div>

                                            <div class="col-md-12">
                                                <p align="justify">
                                                    Caso queira fazer a solicitação pessoalmente, basta fazer o
                                                    <strong>download</strong> do formulário de requerimento de
                                                    informações e entregar no endereço do SIC Presencial informado ao lado. <br><br>
                                                </p>
                                            </div>
                                            <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <a href="<?= base_url() ?>index.php/esic/painel" type="button" class="btn btn-danger"><i data-feather='monitor'></i> Painel de Administração</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
