                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-7 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Elogio</p>
                                </div>
                                <div>
                                    <hr style="margin-top: -10px;">
                                    <div class="card-body">
                                        <div class="alert alert-success" role="alert">
                                            <div class="alert-body">O elogio é um tipo de manifestação com o a finalidade de demonstrar ou reconhecer satisfação sobre o serviço oferecido ou atendimento recebido pelo órgão.</div>
                                        </div>
                                        <hr>
                                        <form action="">
                                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <button type="file" class="btn btn-primary"><i data-feather='send'></i> Enviar elogio</button>
                                                    </div>
                                                </div>
