                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-7 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Reclamação</p>
                                </div>
                                <div>
                                    <hr style="margin-top: -10px;">
                                    <div class="card-body">
                                        <div class="alert alert-success" role="alert">
                                            <div class="alert-body">A reclamação é uma manifestação que se aplica para o ato de insatisfação relacionada a prestação de um serviço público.</div>
                                        </div>
                                        <hr>
                                        <form action="">
                                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <button type="file" class="btn btn-primary"><i data-feather='send'></i> Enviar reclamação</button>
                                                    </div>
                                                </div>
