                ...
                <section id="input-sizing">
                    <div class="row match-height">
                        ...
                        <div class="col-md-7 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <p class="card-title">Denúncia</p>
                                </div>
                                <div>
                                    <hr style="margin-top: -10px;">
                                    <div class="card-body">
                                        <div class="alert alert-success" role="alert">
                                            <div class="alert-body">A denúncia é um tipo de manifestação que visa a comunicação de prática de algum ato ilícito cuja solução dependa da atuação do órgão de controle interno ou externo.</div>
                                        </div>
                                        <hr>
                                        <form action="">
                                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <button type="file" class="btn btn-primary"><i data-feather='send'></i> Enviar denúncia</button>
                                                    </div>
                                                </div>
