                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Emenda é uma proposição apresentada como acessória ou aderente à uma lei principal, que já se encontra em tramitação. </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Emendas Legislativas</h4><br><br>                       
                                <div class="btn-group">
                                    <a  class="btn btn-primary" type="button" href="<?= base_url() ?>index.php/legislativo/novaEmenda">
