                        ...
                        <div>
                            <div class="alert" role="alert">
                                <div class="alert-body">
                                    <span>Projetos de resolução são destinados a regular as matérias da competência privativa da Câmara e as de caráter político, processual, legislativo ou administrativo. A resolução aprovada e promulgada tem eficácia de lei ordinária.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Resolução</h4><br><br>
                            <!--
                                <div class="col-md-2">
                                ...
                                <a href="<?= base_url() ?>index.php/legislativo/novaResolucao" class="btn btn-primary">
                                                ...
                                                <table class="table table-hover table-striped custom_tabela">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 75%;">Ementa</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/resolucao/dtresolucao';">
                                                            <td><span class="font-weight-bold">120</span></td>
                                                            <td>26/03/2021</td>
                                                            <td>AUTORIZA A BAIXA DE BENS PATRIMONIAS INSERVIVEIS DO PODER LEGISLATIVO E, DÁ OUTRAS PROVIDÊNCIAS.</td>
                                                        </tr>
                                                        <tr onclick="window.location.href = '<?= base_url() ?>index.php/resolucao/dtresolucao';">
